...
using Discount.API.WebApi.Extensions.SwaggerOptions;
    ...
    public static class ApplicationServiceExtension
    {
        ...
        private static void AddHealthChecks(this IServiceCollection services, IConfiguration config)
        {
            services.AddHealthChecks()
                .AddNpgSql(config.GetSection("DatabaseSettings:ConnectionString").Value,
                    name: "Discount API Postgres Database Health",
